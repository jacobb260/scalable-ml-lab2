...
## Model Evaluation
To further evaluate the models beyond a comparison of evaluation loss, their outputs were analyzed. Each model was given the same input prompt twice, with the temperature set to 0.1 to encourage more deterministic responses. The prompts included simple mathematical equations, more advanced mathematical problems, geographical questions, and questions drawn from the FineTome dataset. The improved model demonstrated superior performance compared to the base model in several respects. It answered a greater number of questions overall and provided a higher proportion of correct answers. In contrast, the base model more frequently repeated questions it was unable to answer, a behavior that was observed less often in the improved model. Both models performed well on the questions from the FineTome dataset. The results of the evaluation are visible in modellutvärdering.txt.
